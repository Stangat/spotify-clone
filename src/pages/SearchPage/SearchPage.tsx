...
const TYPES = [{name: 'All', type: ['track,playlist,album,artist']}, {name:'song', type: 'track'}, {name: 'playlist', type: 'playlist'}, {name: 'albums', type: 'album'}, {name: 'Artists', type:'artist'}];
